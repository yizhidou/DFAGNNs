...
class Sampler(abc.ABC):
    ...
    def __init__(
            ...
            *args,
            ...
            if_estimate_max_step=True,  # edited by yzd
            **kwargs,
    ):
        ...
        if num_samples < 0 and if_estimate_max_step:
    ...
    @abc.abstractmethod
    def _sample_data(self, length: Optional[int] = None, *args, **kwargs) -> List[_Array]:
        pass
